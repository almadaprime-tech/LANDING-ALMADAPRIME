# Almada Prime — Guidelines de Identidade Visual

Resumo curto
- Tom: Luxo discreto; moderno com referências clássicas.
- Cores principais: preto profundo (#070609) e dourado subtil (#CBB67A).
- Tipografia: `Playfair Display` para headings; `Inter` para corpo.

Paleta
- --ap-black: #070609 — fundo principal, espaço negativo.
...
Tipografia
- Headings: `Playfair Display` — elegante, contrastes fortes, para reforçar luxo.
- Corpo: `Inter` — legibilidade digital e neutralidade moderna.
- Espaçamento: usar mais espaço em branco; margens amplas e linhas arejadas.
...
Ficheiros incluídos
- `brand.css` — variáveis e utilitários
